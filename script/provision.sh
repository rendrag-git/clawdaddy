...
# ---------------------------------------------------------------------------
# Voice Calibration — 7-day post-provisioning personality refinement
# ---------------------------------------------------------------------------

# Create the calibration script
cat > /home/ubuntu/clawdaddy/voice-calibration.sh <<'VOICECALSCRIPT'
#!/bin/bash
...
# Create systemd timer — fires 7 days after boot, then weekly
...
echo "Voice calibration timer enabled (first run: 7 days after boot, then weekly)"
